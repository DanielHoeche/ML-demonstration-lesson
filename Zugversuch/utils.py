...
def finalize_models(X, y):
    ...
    model_1 = MLPRegressor(hidden_layer_sizes=(5,5), activation='relu', solver='adam', alpha=0.1,
                           learning_rate_init=0.01, learning_rate='constant', random_state=7)

    model_2 = MLPRegressor(hidden_layer_sizes=(5,5), activation='relu', solver='adam', alpha=0.1,
